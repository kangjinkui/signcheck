...
WITH rc AS (INSERT INTO rule_condition (sign_type, install_subtype, floor_min, ad_type, priority) VALUES ('벽면이용간판', 'wall_sign_top_building', 4, 'self', 150) RETURNING id)
...
WITH rc AS (INSERT INTO rule_condition (sign_type, install_subtype, floor_min, ad_type, priority) VALUES ('벽면이용간판', 'wall_sign_top_building', 4, 'third_party', 155) RETURNING id)
INSERT INTO rule_effect (rule_id, decision, review_type, safety_check, max_area, max_protrusion, display_period, warnings, provision_id)
SELECT rc.id, 'permit', '대심의', true, 225.00, 0.40, '3년',
