...
INSERT INTO rule_effect (rule_id, decision, review_type, display_period, warnings, provision_id)
SELECT rc.id, 'report', '소심의', '1년',
  '["자사광고만 표시 가능, 전기·조명 사용 불가 (서울시 조례 제9조의2)"]'::jsonb,
